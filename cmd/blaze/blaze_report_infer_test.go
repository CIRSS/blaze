...
func TestReportInfer_rdfs_subClassOf(t *testing.T) {
	...
	t.Run("infer-none-do-not-include-inferred", func(t *testing.T) {
		outputBuffer.Reset()
		Program.Invoke("blaze destroy --all --quiet")
		Program.Invoke("blaze create --quiet --dataset kb --infer none")
		Program.InvokeOnInput("blaze import --format ttl", assertedTriples)
		Program.InvokeOnInput("blaze report --includeinferred=false", reportTemplate)
	...
	t.Run("infer-none-include-inferred", func(t *testing.T) {
		outputBuffer.Reset()
		Program.Invoke("blaze destroy --all --quiet")
		Program.Invoke("blaze create --quiet --dataset kb --infer none")
		Program.InvokeOnInput("blaze import --format ttl", assertedTriples)
		Program.InvokeOnInput("blaze report --includeinferred=true", reportTemplate)
		util.LineContentsEqual(t, outputBuffer.String(),
			`type
			===
	...
	t.Run("infer-rdfs-do-not-include-inferred", func(t *testing.T) {
		outputBuffer.Reset()
		Program.Invoke("blaze destroy --all --quiet")
	...
	t.Run("infer-rdfs-include-inferred", func(t *testing.T) {
		outputBuffer.Reset()
		Program.Invoke("blaze destroy --all --quiet")
		Program.Invoke("blaze create --quiet --dataset kb --infer rdfs")
		Program.InvokeOnInput("blaze import --format ttl", assertedTriples)
	...
	t.Run("infer-owl-do-not-include-inferred", func(t *testing.T) {
		outputBuffer.Reset()
		Program.Invoke("blaze destroy --all --quiet")
	...
	t.Run("infer-owl-include-inferred", func(t *testing.T) {
		outputBuffer.Reset()
		Program.Invoke("blaze destroy --all --quiet")
		Program.Invoke("blaze create --quiet --dataset kb --infer owl")
		Program.InvokeOnInput("blaze import --format ttl", assertedTriples)
